...
def pa1(appObject, fa1):
    appObject.turn += 1

    if appObject.turn % 2 == 0:
        print("even")
    elif appObject.turn % 2 != 0:
        print("odd")
...
class app:
	...
	def init_game(self, frame):
		...
		self.a1 = Label(frame, textvariable=fa1, borderwidth=2, relief="groove")
		self.a2 = Label(frame, textvariable=fa2, borderwidth=2, relief="groove")
		self.a3 = Label(frame, textvariable=fa3, borderwidth=2, relief="groove")
		self.b1 = Label(frame, textvariable=fb1, borderwidth=2, relief="groove")
		self.b2 = Label(frame, textvariable=fb2, borderwidth=2, relief="groove")
		self.b3 = Label(frame, textvariable=fb3, borderwidth=2, relief="groove")
		self.c1 = Label(frame, textvariable=fc1, borderwidth=2, relief="groove")
		self.c2 = Label(frame, textvariable=fc2, borderwidth=2, relief="groove")
		self.c3 = Label(frame, textvariable=fc3, borderwidth=2, relief="groove")
